...
const Header1 = props => (
        ...
        <nav className='header-nav'>
          <div className='hamburger-button'>
            ...
            <ul>
              <li><a className='header-link' type='button' href='/hiphop'>Hip Hop</a></li>
              <li><a className='header-link' type='button' href='/house'>House</a></li>
              <li><a className='header-link' type='button' href='/trap'>Trap</a></li>
              <li><a className='header-link' type='button' href='/progressivehouse'>Progressive House</a></li>
              <li><a className='header-link' type='button' href='/electropop'> Electro Pop</a></li>
              <li><a className='header-link' type='button' href='/heavy'>Heavy</a></li>
              <li><a className='header-link' type='button' href='/other'>Other</a></li>
              <li><a  className='header-link'type='button' href='/'>Home</a></li>
            </ul>
          </div> 
        </nav>
